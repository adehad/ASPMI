...
% 1.4c
%{
Repeat the experiment in b) for data length of 10, 000 samples.

 What happens to the PSD when the chosen model order is lower (under-modelling)
 or higher (over-modelling) than the correct AR(4) model order?
%}
%% Premable
